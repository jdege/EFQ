...
## EFQBuilder.NotEqual(string, object) Method
returns a EFQ that is true if fieldName is not equal to rightHandSide  
```csharp
public static JDege.EFQ.EFQ NotEqual(string fieldName, object rightHandSide);
```
#### Parameters
<a name='JDege_EFQ_EFQBuilder_NotEqual(string_object)_fieldName'></a>
`fieldName` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The name of the field to compare against
  
<a name='JDege_EFQ_EFQBuilder_NotEqual(string_object)_rightHandSide'></a>
